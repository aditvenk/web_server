...
void* Malloc ( size_t num_bytes) {
    ...
    if (ret == NULL)
        unix_error("Memory Allocation Failure");
    return ret;
}
...
void Pthread_create (pthread_t *t, pthread_attr_t *attr, void *(*routine)(void *), void *arg) {
